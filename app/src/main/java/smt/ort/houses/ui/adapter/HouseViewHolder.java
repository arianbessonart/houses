...
public class HouseViewHolder extends BaseViewHolder<House, OnRecyclerObjectClickListener> {
    ...
    public HouseViewHolder(View itemView, OnRecyclerObjectClickListener listener) {
